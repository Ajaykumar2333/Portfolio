...
const uxProcess = [
  ...
  { name: "Stakeholder Collab.", emoji: "🤝" },
  { name: "Developer Handoff", emoji: "🔄" },
];
      ...
      <div className="skills-container">
        ...
        <div className="skills-card skills-card--dev">
          <div className="skills-card-head">
            ...
            <p className="dev-inline-note">I understand code — HTML, CSS, JS, and React basics — so I design for how it actually gets built.</p>
          </div>
        ...
        {/* EXTRA SKILLS — de-emphasized, bottom of section */}
        <div className="skills-extra-row">
          <span className="skills-extra-label">Also skilled in:</span>
          <div className="tool-chips">
            {extraSkills.map((t) => (
              <div key={t.name} className="tool-chip">
                <img src={t.icon} alt={t.name} className="tool-chip-img" onError={e => e.target.style.display='none'} />
